"""Custom Pygments syntax highlighting styles for litestar-asyncapi documentation.

Provides light and dark themes tuned to the Shibuya amber accent used by the
litestar-asyncapi documentation site.
"""
...
class LitestarAsyncApiLightStyle(Style):
    """Light syntax highlighting style for litestar-asyncapi documentation.
...
class LitestarAsyncApiDarkStyle(Style):
    """Dark syntax highlighting style for litestar-asyncapi documentation.

    Mirrors :class:`LitestarAsyncApiLightStyle` with the keyword accent swapped to
    Tailwind ``amber-400`` (``#fbbf24``) for contrast on the Shibuya dark
    background.
    """

    name = "litestar-asyncapi-dark"
